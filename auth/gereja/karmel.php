...
<head>
    ...
    <head>
        ...
        <title>Karmel CC - Immanuel Community</title>
    </head>
    ...
    <section class="contact-section py-5">
        <div class="row">
            <div class="col-md-6 mb-5">
                <div class="card">
                    <h1 class="mb-3">Karmel Community Church</h1>
                    <img src="../../assets/foto_gereja/Gereja Karmel.jpg" class="card-img-top" alt="Church Image">
                    <div class="card-body text-center">
                        <h5><i class="fa-solid fa-location-dot"></i> Jl. Nangka Sel. No.43, Lamper Kidul, Kec. Semarang Sel., Kota Semarang, Jawa Tengah 50249 <br> Telp : 8443375 </h5>
                        <a href="https://maps.app.goo.gl/C9YiyXLEsWncM8ee8" target="_blank" class="btn btn-primary" style="background-color: #000000; border: none;">
                            Lihat Lokasi
                        </a>
                    </div>
                </div>
            ...
            <div class="col-md-6" style="text-align: left;">
                ...
                <p>Setiap Minggu | 06.00 WIB, 08.00 WIB, & 16.30 WIB</p>
                <hr>

                <h3 class="mt-4"> DOA PAGI (DISERTAI ZOOM)</h3>
                <p>Setiap Selasa-Sabtu | 05.00 - 06.00 WIB
                    Di Karmel CC</p>
                <hr>

                <h3 class="mt-4"> KARMEL BERDOA</h3>
                <p>Setiap Jumat | 18.00 WIB </p>
                <hr>

                <h3 class="mt-4"> IBADAH YOUTH & TEEN ELYON</h3>
                <p>Setiap Sabtu | 17.45 WIB</p>
                <hr>

                <h3 class="mt-4"> IBADAH SEKOLAH MINGGU</h3>
                <p>
                    - Ranting Karmel: Setiap Minggu | 08.00 WIB & 16.30 WIB <br>
                    - Ranting Tandang : Setiap Sabtu | 16.00 WIB</p>
                <hr>
                <div class="qr-section">
                    <div class="qr-item">
                        <img src="../../assets/kolekte1/k1-karmel.jpg" alt="QR Code 1">
                        <p>Kolekte 01</p>
                    </div>
                    <div class="qr-item">
                        <img src="../../assets/kolekte2/k2-karmel.jpg" alt="QR Code 2">
                        <p>Kolekte 02</p>
                    </div>
                    <div class="qr-item">
                        <img src="../../assets/perpuluhan/p-karmel.jpg" alt="QR Code 3">
                        <p>Perpuluhan</p>
                    </div>
                </div>
            </div>
