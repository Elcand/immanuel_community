...
<head>
    ...
    <head>
        ...
        <title>Sinai CC - Immanuel Community</title>
    </head>
    ...
    <section class="contact-section py-5">
        <div class="row">
            <div class="col-md-6 mb-5">
                <div class="card">
                    <h1 class="mb-3">Sinai Community Church</h1>
                    <img src="../../assets/foto_gereja/Gereja Sinai.jpeg" class="card-img-top" alt="Church Image">
                    <div class="card-body text-center">
                        <h5><i class="fa-solid fa-location-dot"></i> Jl. Muradi No.52, Kalibanteng Kulon, Kec. Semarang Barat, Kota Semarang, Jawa Tengah 50183 <br>Telp: 7606167 HP: 08995854173</h5>
                        <a href="https://maps.app.goo.gl/W7QJNFpen1mov1b77" target="_blank" class="btn btn-primary" style="background-color: #000000; border: none;">
                            Lihat Lokasi
                        </a>
                    </div>
                </div>
            ...
            <div class="col-md-6" style="text-align: left;">
                ...
                <p>Ibadah I : 06.30 WIB <br>
                    Ibadah II : 09.00 WIB <br>
                    Ibadah III : 17.00 WIB</p>
                <hr>
                <div class="qr-section">
                    <div class="qr-item">
                        <img src="../../assets/kolekte1/k1-sinai.jpg" alt="QR Code 1">
                        <p>Kolekte 01</p>
                    </div>
                    <div class="qr-item">
                        <img src="../../assets/kolekte2/k2-sinai.jpg" alt="QR Code 2">
                        <p>Kolekte 02</p>
                    </div>
                    <div class="qr-item">
                        <img src="../../assets/perpuluhan/p-sinai.jpg" alt="QR Code 3">
                        <p>Perpuluhan</p>
                    </div>
                </div>
            </div>
