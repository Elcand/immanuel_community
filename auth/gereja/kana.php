        ...
        <div class="row">
            <div class="col-md-6 mb-5">
                ...
                <div class="qr-section">
                    <div class="qr-item">
                        <img src="../../assets/kolekte1/k1-kana.jpg" alt="QR Code 1">
                        <p>Kolekte 01</p>
                    </div>
                    <div class="qr-item">
                        <img src="../../assets/kolekte2/k2-kana.jpg" alt="QR Code 2">
                        <p>Kolekte 02</p>
                    </div>
                    <div class="qr-item">
                        <img src="../../assets/perpuluhan/p-kana.jpg" alt="QR Code 3">
                        <p>Perpuluhan</p>
                    </div>
                </div>
            </div>
            ...
            <div class="col-md-6" style="text-align: left;">
                ...
                <p>Selasa-Sabtu | 04.30 WIB di Gereja</p>
                <hr>

                <h3 class="mt-4"> KOMSEL UMUM DAN KELUARGA MUDA</h3>
                <p>Setiap Senin & Rabu | 18.30 WIB</p>
                <hr>

                <h3 class="mt-4"> KOMISI WANITA SOLAMIT</h3>
                <p>Setiap Selasa | 18.00 WIB</p>
                <hr>
