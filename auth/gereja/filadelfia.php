...
<body>
    ...
    <section class="contact-section py-5">
        ...
        <div class="qr-section">
            <div class="qr-item">
                <img src="../../assets/kolekte1/k1-filadelfia.jpg" alt="QR Code 1">
                <p>Kolekte 01</p>
            </div>
            <div class="qr-item">
                <img src="../../assets/kolekte2/k2-filadelfia.jpg" alt="QR Code 2">
                <p>Kolekte 02</p>
            </div>
            <div class="qr-item">
                <img src="../../assets/perpuluhan/p-filadelfia.jpg" alt="QR Code 3">
                <p>Perpuluhan</p>
            </div>
        </div>
    </section>
